    ...
    return (
        <div className="text-white mt-8 w-5/6 mx-auto flex flex-col justify-center items-center p-2">
            ...
            <div className="list-container my-10 flex flex-col md:flex-row gap-4">
                ...
                { /*
                   status property changes according to their states such as promise pending fulfilled.
                   I render conditionally according to whatever the status of the state is
                  */
